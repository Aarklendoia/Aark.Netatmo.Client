...
namespace Aark.Netatmo.SDK.Models.Weather
{
    ...
    {
        internal struct StationDataBody
        {
        ...
        internal struct DeviceDashboardData
        {
            [JsonProperty("CO2")]
        ...
        internal struct ModuleDashboardData
        {
            [JsonProperty("time_utc")]
            internal long TimeUtc { get; set; }
        ...
        internal struct Administrative
        {
            [JsonProperty("country")]
            internal string Country { get; set; }
        ...
        internal StationData FromJson(string json) => JsonConvert.DeserializeObject<StationData>(json, Settings);
    }
}
